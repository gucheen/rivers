...
/******/ 	var hotCurrentHash = "618a154635a8c639e208"; // eslint-disable-line no-unused-vars
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst queue_1 = __webpack_require__(\"./src/queue.ts\");\r\nconst quries_1 = __webpack_require__(\"./src/quries.ts\");\r\n/**\r\n * TaskLoaders is the main class of this service worker.\r\n */\r\nclass TaskLoaders {\r\n    constructor() {\r\n        /**\r\n         * Tasks are stored in 'queue'.\r\n         */\r\n        this.queue = new queue_1.Queue();\r\n        /**\r\n         * All data are stored in 'store'.\r\n         */\r\n        this.store = {};\r\n    }\r\n    /**\r\n     * Call target query function of task.\r\n     * Currently all query functions are defined in 'quires.ts'.\r\n     */\r\n    loadData(task) {\r\n        const queryFunc = quries_1.Quries[task.query];\r\n        return queryFunc({\r\n            limit: 100,\r\n            offset: 0,\r\n        });\r\n    }\r\n    processNext() {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            const task = this.queue.dequeue();\r\n            const data = yield this.loadData(task);\r\n            this.store[task.query].push(data);\r\n            console.log(this.store);\r\n        });\r\n    }\r\n}\r\nexports.TaskLoaders = TaskLoaders;\r\n\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/loaders.ts\n// module id = ./src/loaders.ts\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/loaders.ts?");
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nexports.Quries = {\r\n    test: (pagination) => {\r\n        return new Promise((resolve, reject) => {\r\n            setTimeout(() => {\r\n                resolve({\r\n                    page: {\r\n                        total: 100,\r\n                        limit: pagination.limit,\r\n                        offset: pagination.offset,\r\n                    },\r\n                    data: [\r\n                        {\r\n                            id: 1,\r\n                        },\r\n                        {\r\n                            id: 2,\r\n                        },\r\n                    ],\r\n                });\r\n            }, 500);\r\n        });\r\n    }\r\n};\r\n\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/quries.ts\n// module id = ./src/quries.ts\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/quries.ts?");
...
eval("module.exports = __webpack_require__(\"./src/sw.ts\");\n\n\n//////////////////\n// WEBPACK FOOTER\n// multi ./src/sw.ts\n// module id = 0\n// module chunks = 0\n\n//# sourceURL=webpack:///multi_./src/sw.ts?");
